...
namespace MVNet
{
    internal static class Utility
    {
        ...
        /// <summary>
        /// Indicates a new line in the HTTP protocol.
        /// </summary>
        ...
        /// <exception cref="System.ArgumentNullException">Parameter value <paramref name="parameters"/> equals <see langword="null"/>.</exception>
        public static string ToQueryString(IEnumerable<KeyValuePair<string, string>> parameters, bool valuesUnescaped = false, bool keysUnescaped = false)
        {
            ...
            // Remove '&' at the end if there is content
        ...
        /// <summary>
        /// Determines and returns a MIME type based on a file extension.
        /// </summary>
